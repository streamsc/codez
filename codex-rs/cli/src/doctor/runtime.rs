//! Captures how this Codez process was launched.
//!
...
/// Builds the process provenance row for the current Codez executable.
///
...
pub(super) fn runtime_check() -> DoctorCheck {
    ...
    let mut details = vec![
        format!("version: {}", crate::CODEZ_CLI_VERSION),
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled Codez package.");
    }
    check
}
