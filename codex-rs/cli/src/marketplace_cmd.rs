...
#[derive(Debug, Parser)]
#[command(bin_name = "codez plugin marketplace")]
...
enum MarketplaceSubcommand {
    ...
    /// List plugin marketplaces Codez is currently considering and their roots.
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codez plugin marketplace add",
    after_help = "Examples:\n  codez plugin marketplace add ./path/to/marketplace\n  codez plugin marketplace add owner/repo --ref main\n  codez plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "codez plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codez plugin marketplace upgrade",
    after_help = "Examples:\n  codez plugin marketplace upgrade\n  codez plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codez plugin marketplace remove",
    after_help = "Example:\n  codez plugin marketplace remove debug"
)]
