...
fn plugin_remote_section_error_next_step(label: &str, err: &str) -> &'static str {
    ...
    {
        "Ask a workspace admin to enable Codez plugins or plugin sharing."
        ...
        "Update Codez, then try opening the shared plugin again."
...
fn plugin_sharing_disabled_remote_section_error() -> PluginRemoteSectionError {
    PluginRemoteSectionError {
        ...
        message: "Plugin sharing is disabled for this Codez session. Enable plugin sharing to load shared plugins.".to_string(),
    }
}
