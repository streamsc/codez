        ...
        ApprovedExecpolicyAmendment {
            ...
            (
                ...
                vec![
                    actor.subject().into(),
                    "approved".bold(),
                    " Codez to always run commands that start with ".into(),
                    snippet,
                ],
            )
        }
        ...
        TimedOut => match subject {
            ...
            ApprovalDecisionSubject::NetworkAccess { target } => (
                ...
                vec![
                    "Review ".into(),
                    "timed out".bold(),
                    " before Codez could access ".into(),
                    Span::from(target).dim(),
                ],
            ),
        },
        Abort => match subject {
            ...
            ApprovalDecisionSubject::NetworkAccess { target } => (
                ...
                vec![
                    actor.subject().into(),
                    "canceled".bold(),
                    " the request for Codez network access to ".into(),
                    Span::from(target).dim(),
                ],
            ),
        },
