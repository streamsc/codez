...
const APP_TOOLTIP: &str = "Try the **Desktop app**. Run 'codez app' or visit https://chatgpt.com/codex?app-landing-page=true";
const MACOS_APP_TOOLTIP: &str =
    "Run `codez app` to open the Desktop app (it installs on macOS if needed).";
...
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Desktop app**. Run 'codez app' or visit https://chatgpt.com/codex?app-landing-page=true";
...
mod tests {
    ...
    fn desktop_app_tooltip_uses_supported_platform_launcher() {
        ...
        if linux_app_tooltip(LinuxDesktopSession::current()).is_some() {
            ...
            insta::assert_snapshot!(tooltip, @"Run `codez app` to open the Desktop app (it installs on macOS if needed).");
